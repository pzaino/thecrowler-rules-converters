...
// Define the structure for the Wappalyzer technologies JSON
...
func createRule(name string, details WappalyzerTechnology) DetectionRule {
	rule := DetectionRule{
